      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tasks.map((task) => (
          ...
          >
            ...
            {/* Button */}
            <Link to={`/dashboard/taskDetails/${task._id}`}><button className="mt-4 flex items-center gap-2 bg-[#C890A7] text-white px-4 py-2 rounded-md hover:bg-[#A35C7A] transition duration-200">
